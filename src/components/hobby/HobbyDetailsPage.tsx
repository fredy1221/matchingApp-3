...
import { getHobbyImage, hobbies } from '../../data/hobbies';
import { mockUsers } from '../../data/mockUsers';

const HobbyDetailsPage = () => {
  const { hobbyName } = useParams<{ hobbyName: string }>();
  const hobbyImage = getHobbyImage(hobbyName || '');
  ...
  const communityMembers = mockUsers.filter(user =>
    user.hobbies.includes(hobbyName || '')
  );
      ...
      <div className="p-6">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc list-inside text-gray-700">
            <li><strong>Beginner:</strong> Learn the basics and get started.</li>
            <li><strong>Intermediate:</strong> Enhance your skills and techniques.</li>
            <li><strong>Advanced:</strong> Master the craft and challenge yourself.</li>
          </ul>
        </section>
        <section className="mb-8">
